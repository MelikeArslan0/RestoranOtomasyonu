...
namespace RestoranOtomasyonu.Migrations
{
    ...
    [Migration("20230718122557_DbMasasayisi")]
    partial class DbMasasayisi
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RestoranOtomasyonu.Models.masa", b =>
                {
                    ...
                    b.HasOne("RestoranOtomasyonu.Models.masasayisi", "masasayisi")
                        .WithMany("masa")
                        .HasForeignKey("masasayisiID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("masasayisi");
